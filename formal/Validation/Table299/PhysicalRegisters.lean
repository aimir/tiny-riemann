...
def registerSlot (r : RegisterIndex) : Fin 9 :=
  match r.val with
  | 0 => ⟨1, by decide⟩ | 1 => ⟨0, by decide⟩ | 2 => ⟨5, by decide⟩
  | 3 => ⟨4, by decide⟩ | 4 => ⟨2, by decide⟩ | 5 => ⟨8, by decide⟩
  | 6 => ⟨3, by decide⟩ | 7 => ⟨6, by decide⟩ | _ => ⟨7, by decide⟩

def slotRegister (r : Fin 9) : RegisterIndex :=
  match r.val with
  | 0 => ⟨1, by decide⟩ | 1 => ⟨0, by decide⟩ | 2 => ⟨4, by decide⟩
  | 3 => ⟨6, by decide⟩ | 4 => ⟨3, by decide⟩ | 5 => ⟨2, by decide⟩
  | 6 => ⟨7, by decide⟩ | 7 => ⟨8, by decide⟩ | _ => ⟨5, by decide⟩
