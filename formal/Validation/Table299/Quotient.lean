import Validation.Table299.Invariants
import Validation.AcceptanceTargets.Machine299
...
def quotientMap (q : Fin 342) : Fin 299 :=
...
/-- [proof-guide] The literal 342-state and 299-state machines have equivalent blank-tape halting behavior.
Proof: Combines `halts_iff_of_invariant_quotient`, `quotient_transitions` with the displayed local equations.
Role: Supports the separate acceptance checks; this module is outside the 278-state headline dependency chain. -/
theorem machine342_iff_machine299 :
