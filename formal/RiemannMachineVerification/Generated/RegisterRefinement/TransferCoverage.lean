import RiemannMachineVerification.Generated.RegisterRefinement.TransferSites
...
Proof: Combines `transfer_site_24`, `transfer_site_32`, `transfer_site_40` with the displayed local equations.
...
/-- [proof-guide] Collects the finite cases for the displayed high-counter chunk, covering every low index.
Proof: Combines `transfer_site_72`, `transfer_site_80`, `transfer_site_92` with the displayed local equations.
Role: Connects the implementation register program to the arithmetic program despite different temporary values. -/
...
/-- [proof-guide] Collects the finite cases for the displayed high-counter chunk, covering every low index.
Proof: Combines `transfer_site_128`, `transfer_site_136`, `transfer_site_144` with the displayed local equations.
Role: Connects the implementation register program to the arithmetic program despite different temporary values. -/
...
/-- [proof-guide] Collects the finite cases for the displayed high-counter chunk, covering every low index.
Proof: Combines `transfer_site_192`, `transfer_site_200`, `transfer_site_208` with the displayed local equations.
Role: Connects the implementation register program to the arithmetic program despite different temporary values. -/
...
/-- [proof-guide] Collects the finite cases for the displayed high-counter chunk, covering every low index.
Proof: Combines `transfer_site_448`, `transfer_site_456`, `transfer_site_464` with the displayed local equations.
Role: Connects the implementation register program to the arithmetic program despite different temporary values. -/
...
/-- [proof-guide] Collects the finite cases for the displayed high-counter chunk, covering every low index.
Proof: Combines `transfer_site_576`, `transfer_site_584`, `transfer_site_588` with the displayed local equations.
Role: Connects the implementation register program to the arithmetic program despite different temporary values. -/
...
/-- [proof-guide] Collects the finite cases for the displayed high-counter chunk, covering every low index.
Proof: Combines `transfer_site_640`, `transfer_site_648`, `transfer_site_652` with the displayed local equations.
Role: Connects the implementation register program to the arithmetic program despite different temporary values. -/
...
/-- [proof-guide] Collects the finite cases for the displayed high-counter chunk, covering every low index.
Proof: Combines `transfer_site_704`, `transfer_site_712`, `transfer_site_720` with the displayed local equations.
Role: Connects the implementation register program to the arithmetic program despite different temporary values. -/
