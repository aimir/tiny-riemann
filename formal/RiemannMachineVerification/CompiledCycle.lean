import RiemannMachineVerification.CompiledHarmonic
import RiemannMachineVerification.CompiledLcm
import RiemannMachineVerification.ArithmeticSubtraction
...
theorem compiled_cycle (s : Registers) (capacity : ℕ) :
  ...
  have hip : 0 < i := by
    ...
    subst i
    have hp := congrArg RegisterConfiguration.pc hi
