...
/-- [proof-guide] Executing a trajectory in two parts equals executing it for the sum of their lengths.
...
/-- [proof-guide] A stable halting condition remains true at every later point of a trajectory.
