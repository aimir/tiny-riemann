...
/-- [proof-guide] An invariant true initially and preserved by a step holds at every execution time.
...
/-- [proof-guide] Renaming ordinary states preserves whether a configuration is halted.
...
/-- [proof-guide] A transition-preserving state map commutes with execution of one step.
Proof: Rewrites the defining equations and the cited arithmetic or execution facts.
Role: Supplies the simulation and execution facts used to compose the headline equivalence. -/
...
/-- [proof-guide] A halted tape configuration is a fixed point of execution.
Proof: Rewrites the defining equations and the cited arithmetic or execution facts.
Role: Supplies the simulation and execution facts used to compose the headline equivalence. -/
...
/-- [proof-guide] Once a run halts, its next configuration is the same.
Proof: Rewrites the defining equations and the cited arithmetic or execution facts.
Role: Supplies the simulation and execution facts used to compose the headline equivalence. -/
...
/-- [proof-guide] A halted run stays halted at all later times.
Proof: Induction on `d`, using the displayed step equations and auxiliary lemmas.
Role: Supplies the simulation and execution facts used to compose the headline equivalence. -/
