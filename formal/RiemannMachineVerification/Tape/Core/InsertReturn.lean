import RiemannMachineVerification.Tape.Core.Insertion
import RiemannMachineVerification.Tape.Core.Return
namespace RiemannMachineVerification

/-- [proof-guide] Insertion followed by the return routine restores the head position with the inserted data.
Proof: Combines `ZExec.trans`, `hr` with the displayed local equations.
