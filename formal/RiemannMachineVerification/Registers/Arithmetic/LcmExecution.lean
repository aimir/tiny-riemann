...
/-- [proof-guide] The register-level divisibility loop computes the countdown test.
...
/-- [proof-guide] The register-level LCM body implements one arithmetic search step.
...
/-- [proof-guide] The register-level LCM loop implements the terminating arithmetic search.
...
/-- [proof-guide] The initialized register-level LCM search returns the required common multiple.
