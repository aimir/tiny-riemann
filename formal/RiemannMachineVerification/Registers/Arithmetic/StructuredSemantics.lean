...
/-- [proof-guide] A terminating structured-program evaluation has a unique result.
Proof: Induction on `ha`, using the displayed step equations and auxiliary lemmas.
