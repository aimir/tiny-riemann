import RiemannMachineVerification.Generated.Arithmetic.Paths
namespace RiemannMachineVerification

/-- [proof-guide] The multiplication loop at address 284 computes the stated natural product and register values.
...
/-- [proof-guide] The multiplication block at address 284 computes the stated natural product and register values.
...
/-- [proof-guide] The multiplication loop at address 340 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 340 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 436 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 436 computes the stated natural product and register values.
...
/-- [proof-guide] The multiplication loop at address 540 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 540 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 596 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 596 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 652 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 652 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 692 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 692 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 780 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 780 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 820 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 820 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 908 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 908 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 948 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 948 computes the stated natural product and register values.
Proof: Combines `h.trans` with the displayed local equations.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication loop at address 1036 computes the stated natural product and register values.
Proof: Composes the displayed previously proved facts by ordinary Lean inference.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
...
/-- [proof-guide] The multiplication block at address 1036 computes the stated natural product and register values.
Proof: Rewrites the defining equations and the cited arithmetic or execution facts.
Role: Connects the arithmetic computation and its search to the exact Counterexample predicate. -/
