...
'''
    ...
    # The public composition theorem is maintained in the theorem-first entry module.
    print('Generated the 278-state reduction certificates; acceptance still requires Lean.')
